...
export default function (props) {
  return (
    <table className="detail"><tbody>
      <tr>
        <td>Estimated</td>
        <td><input type="number" min="0" max="8760" value={props.duration} onChange={props.editDuration}/>h</td>
      </tr>
      <tr>
        <td>Spent</td>
        <td><input type="number" min="0" max="8760" value={props.spent} onChange={props.editSpent}/>h</td>
      </tr>
      <tr>
        <td>Remaining</td>
